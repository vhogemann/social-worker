...
- **Implementation plans**: saved as `*.md` files in the `planning/` directory (e.g. `planning/archive/IMAGE_UPLOADS.md`, `planning/archive/AUTHENTICATION.md`). Each plan must be linked from `PLAN.md` under the relevant section. This is the source of truth for tracking planned and completed work.
