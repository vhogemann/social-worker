# social-worker — roadmap entry point

The canonical roadmap lives in [planning/PLAN.md](planning/PLAN.md).

Use this file only as a short project entry point. Do not maintain a second roadmap here.
...
- [planning/archive](planning/archive) — completed implementation plans and historical decisions
- [planning/future](planning/future) — exploratory ideas and longer-term concepts
